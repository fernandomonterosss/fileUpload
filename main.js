...
/* harmony import */ var _services_carga_imagenes_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./services/carga-imagenes.service */ "./src/app/services/carga-imagenes.service.ts");
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            providers: [
                _services_carga_imagenes_service__WEBPACK_IMPORTED_MODULE_7__["CargaImagenesService"]
            ],
...
var ROUTES = [
    { path: 'fotos', component: _components_fotos_fotos_component__WEBPACK_IMPORTED_MODULE_1__["FotosComponent"] },
    { path: 'carga', component: _components_carga_carga_component__WEBPACK_IMPORTED_MODULE_2__["CargaComponent"] },
...
module.exports = "<div class=\"row\">\n\n    <div class=\"col-md-4\">\n\n        <h3> Seleccione archivos</h3>\n\n        <div appNgDropFiles [archivos]=\"archivos\" (mouseSobre)=\"estaSobreDrop = $event\" [ngClass]=\"{'file-over': estaSobreDrop }\" class=\"well drop-zone\">\n            <h4>Deje caer aqui los archivos</h4>\n            <img src=\"assets/drop-images.png\">\n        </div>\n    </div>\n    <div class=\"col-md-8\">\n\n        <h4>Cargar archivos</h4>\n        <button (click)=\"cargarImagenes()\" [disabled]=\"archivos.length === 0 \" class=\"btn btn-success mr-1\">Cargar a Firebase</button>\n        <button (click)=\"limpiarArchivos()\" class=\"btn btn-danger\">Limpiar</button>\n\n        <table class=\"table\">\n            <thead class=\"thead-dark\">\n                <tr>\n                    <th>Nombre archivo</th>\n                    <th>Tamaño</th>\n                    <th>Progreso</th>\n                </tr>\n            </thead>\n            <tbody>\n                <tr *ngFor=\"let archivo of archivos\">\n                    <td [ngClass]=\"{'text-green': archivo.progreso >= 100 }\">{{ archivo.nombreArchivo }}</td>\n                    <td>{{archivo.archivo.size / 1024 / 1024 | number:'.2-2'}} MB</td>\n                    <td>\n                        <div class=\"progress\">\n                            <div class=\"progress-bar progress-bar-striped bg-success\" role=\"progressbar\" [ngStyle]=\"{'width': archivo.progreso + '%'}\"></div>\n                        </div>\n                    </td>\n                </tr>\n            </tbody>\n        </table>\n    </div>\n</div>"
...
var CargaComponent = /** @class */ (function () {
    ...
    CargaComponent.prototype.pruebaSobreElemento = function (event) {
        console.log(event);
    };
...
var NgDropFilesDirective = /** @class */ (function () {
    ...
    NgDropFilesDirective.prototype._archivoFueDroppeado = function (nombreArchivo) {
    ...
    CargaImagenesService.prototype.cargarImagenesFirebase = function (imagenes) {
        ...
        var _loop_1 = function (item) {
            ...
            var uploadTask = storageRef.child(this_1.CARPETA_IMAGENES + "/" + item.nombreArchivo)
                .put(item.archivo);
            uploadTask.on(firebase__WEBPACK_IMPORTED_MODULE_3__["storage"].TaskEvent.STATE_CHANGED, function (snapshot) { return item.progreso = (snapshot.bytesTransferred / snapshot.totalBytes) * 100; }, function (error) { return console.error('Error al subir', error); }, function () {
...
module.exports = __webpack_require__(/*! C:\Users\Fernando Monteros\desktop\ejercicios\angular\17-fileupload\src\main.ts */"./src/main.ts");
